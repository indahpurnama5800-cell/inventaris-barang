...
| Bahasa | PHP 8.2 |
| Database | MySQL |
| Frontend | Bootstrap 5, Blade Template, JavaScript |
...
### 📊 Dashboard
![Dashboard](databarang/dashboard.png)
...
**7. Atur konfigurasi database** pada file `.env`, kemudian jalankan migrasi database.
```bash
