...
@if ($outOfStockCount > 0 || $needRestockCount > 0)
    <div class="alert alert-warning border-0 shadow-sm d-flex align-items-center gap-2 mb-4">
        ...
        <div>
            ...
            @endif
            <a href="{{ route('items.index') }}?status=low" class="ms-2">Lihat detail →</a>
        </div>
    </div>
@endif
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <a href="{{ route('items.index') }}?status=low" class="d-block text-center small mt-2">Lihat semua barang menipis →</a>
            </div>
        </div>
    </div>
</div>
